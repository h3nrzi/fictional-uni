...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="container container--narrow page-section">
        <div class="create-note">
            ...
            <textarea class="new-note-body" name="" placeholder="Your Note"></textarea>
        ...
        <ul class="min-list link-list" id="my-notes">
			...
			while ( $user_notes->have_posts() ) : $user_notes->the_post(); ?>
                <li data-id="<?php the_ID(); ?>">
                    <input class="note-title-field" value="<?php echo str_replace( "Private: ", "", esc_attr( get_the_title() ) ); ?>" type="text" readonly>
